...
<script type="text/javascript" src="/js/ssc/ssc.js"></script>
<script type="text/javascript" src="/js/public_touZhu.js"></script>
<script type="text/javascript" src="/js/jqueryJS/timeEnd_ssc.js" ></script>
...
<div class="ChannelBuyBody">
	...
	<div class="ChannelBuyHandle">
		...
		<script>$(function() {getGaoPinBatchCode('T01007');});</script>
			...
			<!--  Banner start  -->
			<ol style="background:url(/images/logo_ssc_b.gif) no-repeat 15px 15px;">
				<li><style>.ActivityWord{ color:#DE0201; font-weight:bold; margin-left:5px;}.ActivityWord:hover{ text-decoration:underline;}</style>
					<img src="/images/word_ssc1.gif" /><i>当前期第<strong id="qihao"></strong>期</i>
