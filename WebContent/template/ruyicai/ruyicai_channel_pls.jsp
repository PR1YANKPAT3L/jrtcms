...
<script type="text/javascript" src="/js/pls/pls.js"></script>
...
<div class="ChannelBuyBody">
		...
		<div class="ChannelBuyBanner">
			...
			<ol style="background:url(/images/logo_pls_d.gif) no-repeat 15px 15px;">
				<li>
					...
					<img src="/images/word_pls.gif" /><i>当前期第<strong id="qihao"></strong>期　固定奖，玩法简单，每晚20：30开奖！　</i><img src="../images/jrkaijiang.gif" />
				</li>
				<li>
			...
			<div class="ChannelBuyHandleMainTab">
				<dl class="ChannelBuyTab">
					<dt class="light" onclick="window.location.href='hemai/pailie3hemai.html'">参与合买</dt>
	...
	<div class="ChannelBuyInfo">
		...
		<div id="ChannelBuyBulletin">
				<%/* <script>$(function(){reHtml(45,'lotno=T01002',false,'ChannelBuyBulletin');});</script>*/ %>
				<!--#include virtual="/kaijiang/pailiesan.html"-->
		</div>
		<!--  排列三开奖公告 end  -->
