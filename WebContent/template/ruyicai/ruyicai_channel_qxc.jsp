...
<script type="text/javascript" src="/js/qxc/qxc.js"></script>
...
<div class="ChannelBuyBody">
		...
		<div class="ChannelBuyBanner">
			...
			<div class="ChannelBuyHandleMainTab">
				<dl class="ChannelBuyTab">
					<dt class="light" onclick="window.location.href='hemai/qixingcaihemai.html'">参与合买</dt>
	...
	<div class="ChannelBuyInfo">
		...
		<div id="ChannelBuyBulletin">
			<%/* <script>$(function(){reHtml(45,'lotno=T01009',false,'ChannelBuyBulletin');});</script>*/ %>
			<!--#include virtual="/kaijiang/qixingcai.html"-->
