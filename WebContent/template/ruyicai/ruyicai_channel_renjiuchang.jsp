...
<script type="text/javascript">
	...
	function flashLottery() {
		reHtml(45, 'lotno=T01004', false, 'batchCodeHtmlCore', 'false');
		reHtml(30, 'lotno=T01004&inssuenum=10', false, 'nightdrawalottery',
				'false');
	...
	<div id="main">
		<div class="touzhu">
			...
			<div class="footballgonggao" id="footballgonggao">
				...
				<!--#include virtual="/kaijiang/renjiuchang.html"-->
            </div>
	...
	<div class="ChannelBuyBanner">
		<ol style="background:url(/images/logo_zc_b.gif) no-repeat 15px 15px;">
			<li>
				...
				<img src="/images/word_rxjc.gif" /><i>当前期第<strong id="qihao3">000000</strong><strong id="qihao2"></strong><strong id="qihao4"></strong><strong id="qihao1"></strong>期　无足彩,不球迷,猜14场比赛，赢百万奖金！　</i><span id="jinrikaijiangId"><!-- 此处会显示今日开奖小图标 --></span>
			</li>
			<li>
		...
		<div class="ChannelBuyHandleMainTab" id="zucainavcon">
			<dl class="ChannelBuyTab">
				<dt class="light" onclick="window.location.href='/hemai/zcrenxuanhemai.html'">参与合买</dt>
		...
		<!--  ChannelBuyBanner end  -->
	 	<div class="ChannelBuyHandleTabContent" style="width:728px;">
			...
			<div class="BuyChoice none selected" id="zucai_area">
				<!--#include virtual="/chlw/function/zucai!getFlData?lotno=T01004"-->
			</div>
