...
<div class="Pannel FastBuy">
	...
	<form action="/chlw/user/bet!bettingByDipin" method="post" id="BettingForm">
	<div class="PannelBody">
		<script>$(function(){getBatchCodesBY('F47104');ssq_dingshi();});</script>
		<div class="FastBuySSQ none selected">
			<table class="FastBuyTable">
				<tr><th rowspan="3"><img class="LogoBig" src="/images/logo_ssq_b.gif" /></th><td>双色球第<b id="ssqqihao"></b>期　
				...
				<tr class="Button"><td>&#160;</td><td colspan="2">
					...
					<a href="/shuangseqiu.html?canshu=zengsong#BettingForm">赠送彩票</a><a href="/shuangseqiu.html?canshu=hemai#BettingForm">发起合买</a>
				</td></tr>
			</table>
		</div>
		<div class="FastBuyDLT none">
			<table class="FastBuyTable">
				<tr><th rowspan="3"><img class="LogoBig" src="/images/logo_dlt_b.gif" /></th><td>大乐透第<b id="dltqihao"></b>期　
				奖池：<i id="dltJC"></i>元
				</td><th rowspan="2">&#160;</th></tr>
				...
				<tr class="Button"><td>&#160;</td><td colspan="2">
					...
					<a href="/daletou.html?canshu=zengsong#BettingForm">赠送彩票</a><a href="/daletou.html?canshu=hemai#BettingForm">发起合买</a>
				</td></tr>
			</table>
		</div>
	</div>
