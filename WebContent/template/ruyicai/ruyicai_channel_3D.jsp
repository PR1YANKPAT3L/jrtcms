...
<script type="text/javascript" src="/js/3D/3D.js"></script> 
...
<div class="ChannelBuyBody">
		...
		<div class="ChannelBuyBanner">
			...
			<ol style="background:url(/images/logo_fcsd_b.gif) no-repeat 15px 15px;">
				<li>
					...
					<img src="/images/word_fcsd.gif" /><i>当前期第<strong id="qihao"></strong>期　每晚开奖，玩法简单，2元赢取1000元！　</i><img src="../images/jrkaijiang.gif" />
				</li>	
				<li>
			...
			<div class="ChannelBuyHandleMainTab">
				<dl class="ChannelBuyTab">
					<dt class="light" onclick="window.location.href='/hemai/fucai3dhemai.html'">参与合买</dt>
	...
	<div class="ChannelBuyInfo">
		...
		<div id="ChannelBuyBulletin">
				<%/* <script>$(function(){reHtml(45,'lotno=F47103',false,'ChannelBuyBulletin');});</script>*/ %>
				<!--#include virtual="/kaijiang/fucai3D.html"-->
		</div>
		<!--  福彩3D开奖公告 end  -->
