...
<script type="text/javascript" src="/js/ssq/ssq.js"></script>
...
<div class="ChannelBuyBody">
		...
		<div class="ChannelBuyBanner">
			...
			<ol style="background:url(/images/logo_ssq_b.gif) no-repeat 15px 15px;">
				<li>
					...
					<img src="/images/word_ssq.gif" /><i>当前期第<strong id="qihao"></strong>期　每周二、四、日晚开奖，单注最高奖金1000万元！　</i><span id="jinrikaijiangId"><!-- 此处会显示今日开奖小图标 --></span>
				</li>
				<li>
			...
			<div class="ChannelBuyHandleMainTab">
				<dl class="ChannelBuyTab">
					<dt class="light" onclick="window.location.href='hemai/shuanseqiuhemai.html'">参与合买</dt>
	...
	<div class="ChannelBuyInfo">
		...
		<div id="ChannelBuyBulletin">
				<%/* <script>$(function(){reHtml(45,'lotno=F47104',false,'ChannelBuyBulletin');});</script>*/ %>
				<!--#include virtual="/kaijiang/shuangseqiu.html"-->
		</div>
		<!--  双色球开奖公告 end  -->
