...
<script type="text/javascript" src="/js/dlt/dlt.js"></script>
...
<div class="ChannelBuyBody">
		...
		<div class="ChannelBuyBanner">
			...
			<div class="ChannelBuyHandleMainTab">
				<dl class="ChannelBuyTab">
					<dt class="light" onclick="window.location.href='hemai/daletouhemai.html'">参与合买</dt>
					...
					<dd>
						<a onmouseover="PopupOn($(this));" onmouseout="PopupOff($(this));" Offset="br,0,0" BoxStyle="width:200px;line-height:20px;" Content="<tangs:ryc_newslist categoryCn="玩法简介" channelCn="大乐透" value="3" web_id="%{#parameters.website_Properties_id[0]}" num="1"> <h3 style='line-height:26px;'>${title}</h3>${content}</tangs:ryc_newslist>" target="_blank" href='http://www.ruyicai.com/cms/a/bangzhuzhongxin/wanfajieshao/2012/0327/9.html?fid=36&id=9'>玩法介绍</a>
			...
			<div class="ChannelBuyHandleSecondTab">
				<dl class="ChannelBuyTab BuyChoice none selected" ControlTarget="BuyNormal">
					<dt class="BuyNormal light selected" ControlTarget="BuyNormalContent" onclick="setErjiwanfa('普通投注');judgeCaizhong();dltZhuijiaNone();putongChange();" id="dlt_pttz">普通投注</dt>
					<dt class="BuyCourage light" ControlTarget="BuyCourageContent" onclick="setErjiwanfa('胆拖投注');judgeCaizhong();dltZhuijiaNone();putongChange();">胆拖投注</dt>
					<dt class="BuyUpload light" ControlTarget="BuyUploadContent" onclick="setErjiwanfa('单式上传');judgeCaizhong();dltZhuijiaNone();putongChange();chushihuaRedio();">单式上传</dt>
					<dt class="Dingdanshahao light" ControlTarget="DingdanshahaoContent" onclick="setErjiwanfa('杀号定胆机选');judgeCaizhong();dltZhuijiaNone();putongChange();ddsh_ClearSelect();" >定胆杀号</dt>
					<dt class="BuyShengxiao light" ControlTarget="BuyShengxiaoContent" onclick="setErjiwanfa('生肖乐');judgeCaizhong();dltZhuijia();shengxiaoleChange();" >生肖乐</dt>
				</dl>
		...
		<form name="BettingForm" id="BettingForm" action="/chlw/user/bet!bettingByDipin" method="post">
			<div class="ChannelBuyHandleTabContent">
				<div class="BuyNormalContent none selected" id="sub_nav_1">
					<jsp:include page="/function/ruyicai_dlt/dlt_common.jsp"/>
				</div>
				<div class="BuyCourageContent none" id="sub_nav_2">
					<jsp:include page="/function/ruyicai_dlt/dlt_danTuo.jsp"/>
				</div>
				<div class="BuyShengxiaoContent none" id="sub_nav_3">
					<jsp:include page="/function/ruyicai_dlt/dlt_12choose2.jsp"/>
				</div>
				<div class="BuyUploadContent ChannelBuyUpload none">
					<jsp:include page="/function/ruyicai_dlt/dlt_danshiUpload.jsp"/>
				</div>
				<div class="DingdanshahaoContent none " id="sub_nav_4">
					<jsp:include page="/function/ruyicai_dlt/dlt_dingdanshahao.jsp"/>
				</div>
	        ...
	        <input type="hidden" id="DdshTishi" value=""  />
	        <input type="hidden" id="isShaHao" value=""  />
	...
	<div class="ChannelBuyInfo">
		...
		<div id="ChannelBuyBulletin">
				<%/* <script>$(function(){reHtml(45,'lotno=T01001',false,'ChannelBuyBulletin');});</script>*/ %>
				<!--#include virtual="/kaijiang/daletou.html"-->
		</div>
		<!--  大乐透开奖公告 end  -->
		...
		<div class="ChannelBuyPannel ChannelBuyReview">
			<div class="ChannelBuyPannelHead"><h3>大乐透上期开奖点评</h3></div>
			<div class="ChannelBuyPannelBody">
				<ol>
				<tangs:ryc_newslist web_id="2" categoryCn="开奖点评" channelCn="大乐透" value="3" num="1">
				  <li>
					${content}
					</li>
		...
		<div class="ChannelBuyPannel ChannelBuyAnalyse">
			<div class="ChannelBuyPannelHead"><h3>大乐透冷热号分析</h3></div>
			<dl class="ChannelBuyTab">
			...
			<div class="ChannelBuyPannelBody">
				<tangs:ryc_newslist web_id="2" categoryCn="近30期" channelCn="大乐透" value="3" num="1">
				 
					${content}
					
				</tangs:ryc_newslist>
				<tangs:ryc_newslist web_id="2" categoryCn="近50期" channelCn="大乐透" value="3" num="1">
				 
					${content}
					
				
				</tangs:ryc_newslist>
				<tangs:ryc_newslist web_id="2" categoryCn="近100期" channelCn="大乐透" value="3" num="1">
		...
		<div class="ChannelBuyPannel ChannelBuyCollate">
			<div class="ChannelBuyPannelHead"><h3>大乐透奖金对照表</h3></div>
			<div class="ChannelBuyPannelBody">
			<tangs:ryc_newslist web_id="2" categoryCn="奖金对照表" channelCn="大乐透" value="3" num="1">
		...
		<div class="ChannelBuyPannel ChannelBuyCurrent">
			<div class="ChannelBuyPannelHead"><h3>大乐透图表走势</h3><a href="http://tbzs.ruyicai.com/cjwdlt/view/dltyqsfq.php" title="更多"  target="_blank">更多&gt;&gt;</a></div>
			<div class="ChannelBuyPannelBody">
				<ul>
					<tangs:ryc_newslist value="3" categoryCn="频道走势图"  channelCn="大乐透" web_id="%{#parameters.website_Properties_id[0]}" >
...
<!--号码蓝  提示  end-->
<script>dltZhuijiaNone();hemaiInit();zengcaiInit();</script>
