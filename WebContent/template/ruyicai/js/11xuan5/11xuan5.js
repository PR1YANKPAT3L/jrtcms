...
//
//  11选5 选一、选二、选三、任选四、任选五、任选六、任选七、任选八 机选
//  @param n 机选多少注
//  @return
//
function btn_2_RandManyClick(n) {
	...
	if ($("#sub_nav_1").is(":visible")) {
		...
		for (var i = 0; i < parseInt(n); i++) {
			...
			syxwR1 = lottery;
			var controlRed = syxwR1.lastIndexOf(";");
			var red = syxwR1.substring(0, controlRed);
			lotteryNumber = "R1" + parseInt(red, 10) + ";";
		...
		if ($("#sub_nav_2_QEZhiF").is(":visible")) {
			// Q22-8;Q22-8;Q22-8;Q22-8;Q22-8;Q22-8;前二直 选5注 机选	    
			...
			for (var i = 0; i < parseInt(n); i++) {
				...
				syxwR2 = lottery;
				var controlRed = syxwR2.lastIndexOf(";");
				var red = syxwR2.substring(0, controlRed);
				var red2 = "";
				if (red.indexOf(",") > -1) {
					var red3 = red.split(",");
				...
				lotteryNumber = "Q2" + red2.substring(0, red2.length - 1) + ";";
			...
			// Z21,2;Z21,2;Z21,2;Z21,10;Z21,10;前二组选5注	    
			var arr = rollJx(1, 11, 2, parseInt(n));
			ClearAll('Z2', 1);
			for (var i = 0; i < parseInt(n); i++) {
				var lotteryNumber = "";
				...
				lotteryNumber = "Z2" + red2.substring(0, red2.length - 1) + ";";
			...
			// R21,2;R21,2;R21,2;R21,10;;任二单式 5注	    
			var arr = rollJx(1, 11, 2, parseInt(n));
			...
			for (var i = 0; i < parseInt(n); i++) {
				...
				lotteryNumber = "R2" + red2.substring(0, red2.length - 1) + ";";
		...
		if ($("#sub_nav_3_QSZhiF").is(":visible")) {
			// Q36-9-10;Q36-9-10;Q36-9-10;Q36-9-10;Q36-9-10;前三直 选5注 机选	    
			...
			for (var i = 0; i < parseInt(n); i++) {
				...
				lottery = arr1 + ";";
				syxwR3 = lottery;
				var controlRed = syxwR3.lastIndexOf(";");
				var red = syxwR3.substring(0, controlRed);
				var red2 = "";
				if (red.indexOf(",") > -1) {
					var red3 = red.split(",");
					for (var j = 0; j < red3.length; j++) {
				...
				lotteryNumber = "Q3" + red2.substring(0, red2.length - 1) + ";";
				lotteryView = lottery.substring(0, lottery.length - 1);
				//lotteryView = decodeURI(EncodeUtf8(' 前三直选　' ))+lotteryView.replace(/\,/g," ");//显示的注码串
				//var lotteryView2 = lotteryView.replace(/\,/g,"|");
				var opt = new Option(lotteryView, lotteryNumber);
				var frontLot = lottery;
				opt.setAttribute('allLot', frontLot);
				opt.setAttribute('backLot', lotteryNumber);
				opt.setAttribute('wangFang', "Q3");
				opt.setAttribute('zhushu', "1");
				opt.setAttribute('money', 2);
				opt.setAttribute('delMoney', 2);
				lotteryListSelect[0].options.add(opt);
			...
			// Z31,7,10;Z31,7,10;Z31,7,10;Z31,7,10;前三组选5注	    
			var arr = rollJx(1, 11, 3, parseInt(n));
			ClearAll('Z3', 1);
			for (var i = 0; i < parseInt(n); i++) {
				var lotteryNumber = "";
				...
				lotteryNumber = "Z3" + red2.substring(0, red2.length - 1) + ";";

				lotteryView = lottery.substring(0, lottery.length - 1);
				//lotteryView = decodeURI(EncodeUtf8(' 前三组选　' ))+lotteryView.replace(/\,/g," ");//显示的注码串
				//var lotteryView2 = lotteryView.replace(/\,/g,"|");
				var opt = new Option(lotteryView, lotteryNumber);
				var frontLot = lottery;
				opt.setAttribute('allLot', frontLot);
				opt.setAttribute('backLot', lotteryNumber);
				opt.setAttribute('wangFang', "Z3");
				opt.setAttribute('zhushu', "1");
				opt.setAttribute('money', 2);
				opt.setAttribute('delMoney', 2);
				lotteryListSelect[0].options.add(opt);
			...
			// R31,2,3;R31,2,3;R31,2,3;R31,2,3;R31,2,3;任三单式 5注	    
			var arr = rollJx(1, 11, 3, parseInt(n));
			ClearAll('R3', 1);
			for (var i = 0; i < parseInt(n); i++) {
				var lotteryNumber = "";
				...
				lotteryNumber = "R3" + red2.substring(0, red2.length - 1) + ";";

				lotteryView = lottery.substring(0, lottery.length - 1);
				//lotteryView = decodeURI(EncodeUtf8(' 任三单式　' ))+lotteryView.replace(/\,/g," ");//显示的注码串
				//var lotteryView2 = lotteryView.replace(/\,/g,"|");
				var opt = new Option(lotteryView, lotteryNumber);
				var frontLot = lottery;
				opt.setAttribute('allLot', frontLot);
				opt.setAttribute('backLot', lotteryNumber);
				opt.setAttribute('wangFang', "R3");
				opt.setAttribute('zhushu', "1");
				opt.setAttribute('money', 2);
				opt.setAttribute('delMoney', 2);
				lotteryListSelect[0].options.add(opt);
	...
	if ($("#sub_nav_4").is(":visible")) {
		// R41,2,3,4;R41,2,3,4,5,6,7;机选5注	    
		...
		for (var i = 0; i < parseInt(n); i++) {
			...
			syxwR4 = lottery;
			var controlRed = syxwR4.lastIndexOf(";");
			var red = syxwR4.substring(0, controlRed);
			var red2 = "";
			if (red.indexOf(",") > -1) {
				var red3 = red.split(",");
				for (var j = 0; j < red3.length; j++) {
			...
			lotteryNumber = "R4" + red2.substring(0, red2.length - 1) + ";";
			lotteryView = lottery.substring(0, lottery.length - 1);

			//lotteryView = decodeURI(EncodeUtf8(' 任四单式　' ))+lotteryView.replace(/\,/g," ");//显示的注码串
			//var lotteryView2 = lotteryView.replace(/\,/g,"|");
			var opt = new Option(lotteryView, lotteryNumber);
			var frontLot = lottery;
			opt.setAttribute('allLot', frontLot);
			opt.setAttribute('backLot', lotteryNumber);
			opt.setAttribute('wangFang', "R4");
			opt.setAttribute('zhushu', "1");
			opt.setAttribute('money', 2);
			opt.setAttribute('delMoney', 2);
			lotteryListSelect[0].options.add(opt);
	...
	if ($("#sub_nav_5").is(":visible")) {
		...
		for (var i = 0; i < parseInt(n); i++) {
			...
			syxwR5 = lottery;
			var controlRed = syxwR5.lastIndexOf(";");
			var red = syxwR5.substring(0, controlRed);
			var red2 = "";
			if (red.indexOf(",") > -1) {
				var red3 = red.split(",");
				for (var j = 0; j < red3.length; j++) {
			...
			lotteryNumber = "R5" + red2.substring(0, red2.length - 1) + ";";
			lotteryView = lottery.substring(0, lottery.length - 1);
	...
	if ($("#sub_nav_6").is(":visible")) {
		...
		for (var i = 0; i < parseInt(n); i++) {
			...
			syxwR6 = lottery;
			var controlRed = syxwR6.lastIndexOf(";");
			var red = syxwR6.substring(0, controlRed);
			var red2 = "";
			if (red.indexOf(",") > -1) {
				var red3 = red.split(",");
				for (var j = 0; j < red3.length; j++) {
			...
			lotteryNumber = "R6" + red2.substring(0, red2.length - 1) + ";";
			lotteryView = lottery.substring(0, lottery.length - 1);
	...
	if ($("#sub_nav_7").is(":visible")) {
		...
		for (var i = 0; i < parseInt(n); i++) {
			...
			syxwR8 = lottery;
			var controlRed = syxwR8.lastIndexOf(";");
			var red = syxwR8.substring(0, controlRed);
			var red2 = "";
			if (red.indexOf(",") > -1) {
				var red3 = red.split(",");
				for (var j = 0; j < red3.length; j++) {
			...
			lotteryNumber = "R7" + red2.substring(0, red2.length - 1) + ";";
			lotteryView = lottery.substring(0, lottery.length - 1);
	...
	if ($("#sub_nav_8").is(":visible")) {
		...
		for (var i = 0; i < parseInt(n); i++) {
			...
			lotteryNumber = "R8" + red2.substring(0, red2.length - 1) + ";";
			lotteryView = lottery.substring(0, lottery.length - 1);

			//lotteryView = decodeURI(EncodeUtf8(' 任八单式　' ))+lotteryView.replace(/\,/g," ");//显示的注码串
			//var lotteryView2 = lotteryView.replace(/\,/g,"|");
			var opt = new Option(lotteryView, lotteryNumber);
			var frontLot = lottery;
			opt.setAttribute('allLot', frontLot);
...
function btn_2_AddClickQ2zhixuan() {
	...
	if (invest == 1) {
		...
		lotteryView2 = "<span class='jieguo0'>[" + decodeURI(EncodeUtf8('前二直选复式')) + "]" + lotteryView2 + "</span><span class='jieguo1'>  " + invest + decodeURI(EncodeUtf8("注　　共")) + 2 * invest + decodeURI(EncodeUtf8("元")) + "</span>";
	}
	add_codes(lotteryView2, lotteryNumber);
...
function btn_2_AddClickZ2zuxuan() {
	...
	var count = GetBallSelectedNumZ2ZhiF(1);
	if (count > 8) {
		openAlert(decodeURI(EncodeUtf8("您好，该玩法最多只能选8个号码。")));
		return false;
	}
	if (p > 20000) {
		openAlert(decodeURI(EncodeUtf8("您好，单个方案金额不能超过2万元！")));
...
function btn_2_AddClickR2zuxuan() {
	...
	//号码蓝样式
	if (invest == 1) {
		lotteryView2 = "<span class='jieguo0'>[" + decodeURI(EncodeUtf8('任二复式')) + "]" + lotteryView.substring(0, lotteryView.length - 1) + "</span><span class='jieguo1'>　　" + decodeURI(EncodeUtf8("1注　　共2元")) + "</span>";
	} else {
...
function btn_2_AddClickQ3zhixuan() {
	...
	if (invest == 1) {
		...
		lotteryView2 = "<span class='jieguo0'>[" + decodeURI(EncodeUtf8('前三直选复式')) + "]" + lotteryView2 + "</span><span class='jieguo1'>　　" + invest + decodeURI(EncodeUtf8("注　　共")) + 2 * invest + decodeURI(EncodeUtf8("元")) + "</span>";
	}
	add_codes(lotteryView2, lotteryNumber);
...
//11选5_Q3zhixuan.js 结束
//11选5_Q3ZiXuan.js 结束

//11选5_Q3ZuXuan.js 开始
//11选5_Z3ZiXuan.js 开始
function SelectBallZ3(sender) { //前三组选直选
	//获取
...
function btn_2_AddClickR3zuxuan() {
	...
	//号码蓝样式
	if (invest == 1) {
		lotteryView2 = "<span class='jieguo0'>[" + decodeURI(EncodeUtf8('任三复式单式')) + "]" + lotteryView.substring(0, lotteryView.length - 1) + "</span><span class='jieguo1'>　　" + decodeURI(EncodeUtf8("1注　　共2元")) + "</span>";
	} else {
...
function btn_2_AddClickR4ZhiF() {
	...
	//号码蓝样式
	if (invest == 1) {
		lotteryView2 = "<span class='jieguo0'>[" + decodeURI(EncodeUtf8('任四复式')) + "]" + lotteryView.substring(0, lotteryView.length - 1) + "</span><span class='jieguo1'>　　" + decodeURI(EncodeUtf8("1注　　共2元")) + "</span>";
	} else {
...
//11选5_R8ZiXuan.js 开始
function SelectBallR8(sender) { //任八复式直选
	//获取
...
function btn_2_AddClickR8ZhiF() {
	...
	var lotteryView2 = decodeURI(EncodeUtf8('任八复式 　')) + lotteryView.substring(0, lotteryView.length - 1);
	var opt = new Option(lotteryView2, lotteryNumber);
	opt.setAttribute('allLot', frontLot);
	opt.setAttribute('backLot', lotteryNumber);
...
function GetBallSelectedNumR8dantuo(row) {
	var Count = 0;
	for (var i = 1; i < 12; i++) {
		if (GetBallStateR8dantuo(i, row)) Count++;
	}
...
function GetLotteryNumberR8dantuo() {
	...
	for (var j = 0; j < 12; j++) {
		...
		if (GetBallStateR8dantuo(j, 2)) temp += parseInt(obj.innerHTML.trim(), 10) + ",";
	}
	temp = temp.trim();
	ball1 = temp.lastIndexOf(",");
	temp = temp.substring(0, ball1);
	...
	for (var j = 0; j < 12; j++) {
		...
		if (GetBallStateR8dantuo(j, 3)) temp += parseInt(obj.innerHTML.trim(), 10) + ",";
	}
	temp = temp.trim();
	ball1 = temp.lastIndexOf(",");
	temp = temp.substring(0, ball1);
...
function getFrontR8dantuo() {
	...
	for (var j = 1; j < 12; j++) {
		var obj = GetBallObjectR8DanmaOrTuoma(2, j);
		if (GetBallStateR8dantuo(j, 2)) temp += obj.innerHTML.trim() + ",";
	}
	temp = temp.trim();
	LotteryNumber += temp;
...
function getFrontR8dantuo_tuoma() {
	...
	for (var j = 1; j < 12; j++) {
		var obj = GetBallObjectR8DanmaOrTuoma(3, j);
		if (GetBallStateR8dantuo(j, 3)) temp += obj.innerHTML.trim() + ",";
	}
	temp = temp.trim();
	LotteryNumber += temp;
