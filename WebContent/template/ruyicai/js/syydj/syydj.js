...
function btn_2_AddClickR8ZhiF() {
	...
	if (invest == 1) {
		...
		lotteryView2 = "<span class='jieguo0'>[" + decodeURI(EncodeUtf8('任八单式')) + "]" + lotteryView.substring(0, lotteryView.length - 1) + "</span><span class='jieguo1'>　　" + invest + decodeURI(EncodeUtf8("注　　共")) + 2 * invest + decodeURI(EncodeUtf8("元")) + "</span>";
	}
	add_codes(lotteryView2, lotteryNumber);
