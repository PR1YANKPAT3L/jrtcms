...
function getCheck_ballNumber() {
	...
	if (subJiaHou.length <= 3) {
		...
		if (conCount < 2) var douHao = clear$.lastIndexOf(",");
	...
	if (subJiaHou.length > 3 && qianQu1.length == 0) dlt_danTuoCode = cleanDouHou + hou.replace("$", "-") + ";"; // 1,2不选 
	else if (subJiaHou.length > 3 && qianQu1.length != 0) dlt_danTuoCode = qianQu1 + newSecond + replace$ + ";"; //2不选	
