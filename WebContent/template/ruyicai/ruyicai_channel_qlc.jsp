...
<title>如意彩七乐彩投注、开奖公告、开奖点评、冷热号分析、奖金对照表、走势图表</title>  
<meta http-equiv="keywords" content="七乐彩投注，七乐彩开奖公告，七乐彩开奖点评，七乐彩冷热号分析，福七乐彩奖金对照表，七乐彩走势图表"/>
<meta http-equiv="description" content="如意彩七乐彩集投注、开奖公告、开奖点评、冷热号分析、奖金对照表、走势图表为一体是七乐彩一站式服务平台。"/>
...
<script type="text/javascript" src="/js/qlc/qlc.js"></script>
...
<div class="ChannelBuyBody">
		...
		<div class="ChannelBuyBanner">
			...
			<div class="ChannelBuyHandleMainTab">
				<dl class="ChannelBuyTab">
					<dt class="light" onclick="window.location.href='hemai/qilecaihemai.html'">参与合买</dt>
	...
	<div class="ChannelBuyInfo">
		...
		<div id="ChannelBuyBulletin">
				...
				<!--#include virtual="/kaijiang/qilecai.html"-->
		</div>
		<!--  七乐彩开奖公告 end  -->
		...
		<div class="ChannelBuyPannel ChannelBuyCollate">
			<div class="ChannelBuyPannelHead"><h3>七乐彩奖金对照表</h3></div>
			<div class="ChannelBuyPannelBody">
		...
		<div class="ChannelBuyPannel ChannelBuyCurrent">
			...
			<div class="ChannelBuyPannelBody">
				<ul>
					<tangs:ryc_newslist value="3" categoryCn="频道走势图"  channelCn="七乐彩" web_id="%{#parameters.website_Properties_id[0]}" >
