...
<!--左边-->
        <div class="main_left">
  	     <div class="bt"><img src="/images/zhuanjia_message.gif" width="190" height="29"></div>
		<div id="PARENT">
		...
		<li><a href="javaScript:zhuanjiaTree(${id})" ><span class="nochoose" id="choose_${id }">${name_cn}专区</span></a>
		 ...
		 <tangs:ryc_newslist value="11" web_id="%{#parameters.website_Properties_id[0]}" categoryCn="专家短信" channelExpress="#attr['name_cn']">
		  <li><a href="${url }?code1=${id }&code=${channelId}" title="${titl}" id="title_${id }" >${title}</a></li>
		</tangs:ryc_newslist>
		 </ul>
		...
		<li><a href="javaScript:zhuanjiaTree(${id})" ><span class="nochoose" id="choose_${id }">${name_cn}专区</span></a>
		 ...
		 <ul id="ul_${id}" style="display:none" class="expanded">
		 <tangs:ryc_newslist value="11" web_id="%{#parameters.website_Properties_id[0]}" categoryCn="专家短信" channelExpress="#attr['name_cn']">
		  <li><a href="${url }?code1=${id }&code=${channelId}" title="${title}" id="title_${id }" >${title}</a></li>
		</tangs:ryc_newslist>
		 </ul>
  	...
  	<div class="zhj_bt"><img src="/images/kaijiang_message.gif" width="190" height="29"></div>
		<div id="PARENT">
		
		<ul style="overflow:hidden;">
		
		 <tangs:ryc_newslist value="11" web_id="%{#parameters.website_Properties_id[0]}" categoryCn="开奖短信" >
		 <li style="background:#FFF; text-align:center; line-height:24px; border-bottom:1px dotted #DBDBDB; margin:0px 10px;"><a class="light" style="text-align:center;" href="${url }?code1=${id }&code=${channelId}" title="${titl}" >${title}</a></li>
		 </tangs:ryc_newslist>
