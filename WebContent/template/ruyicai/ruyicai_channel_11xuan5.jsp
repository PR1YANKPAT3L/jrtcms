...
<script type="text/javascript" src="/js/jqueryJS/timeEnd_11xuan5.js" ></script>
<script type="text/javascript" src="/js/zhuihaojisuanqi.js"></script>
<script type="text/javascript" src="/js/11xuan5/11xuan5.js"></script>
...
<div class="ChannelBuyBody">
	...
	<div class="ChannelBuyHandle">
		<div class="ChannelBuyBanner">
			...
			<!--  Banner start  -->
			<ol style="background:url(/images/logo_syxw_b.gif) no-repeat 15px 15px;">
				<li>
					<img src="/images/word_syxw.gif" /><i>当前期第<strong id="qihao"></strong>期</i>
		...
		<form name="BettingForm" id="BettingForm" action="/chlw/user/bet!bettingByGaopin" method="post">
...
<script>$(function() {ajaxStatisticWin('T01010');});</script> 
