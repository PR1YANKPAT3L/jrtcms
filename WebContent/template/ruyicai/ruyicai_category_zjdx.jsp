...
<div id="body">
   ...
   <!--#include virtual="/include/zhuanjiaduanxin_left.html" -->	
    <!--中间-->      
    <div class="messagescenter">
		...
		<div class="jinri_kj">
			<div class="zjgrey"><span class="inhelp_zi">专家战绩</span><span class="inhelp_more"><a class="light" href="/zhuanjiazhanji/zhuanjiazhanji__1.html" title="更多">更多>></a></span></div>
			<div class="zhjzx_con">
				<ul>
					<tangs:ryc_newslist value="3"  categoryCn="专家战绩"  web_id="%{#parameters.website_Properties_id[0]}" num="6">
				     <li><a href="${url}" title="${title}"  target="_blank"  style="color:${title_color}"> ${title}</a><span class="fczixun_time">${updatetimeFML}</span></li>
				     </tangs:ryc_newslist>
				</ul>
			</div>
		</div>
