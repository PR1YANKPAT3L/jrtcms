...
<script type="text/javascript">
	...
	function flashLottery() {
		reHtml(45, 'lotno=T01005', false, 'batchCodeHtmlCore', 'false');
		reHtml(30, 'lotno=T01005&inssuenum=10', false, 'nightdrawalottery',
				'false');
	...
	<div id="main">
		<div class="touzhu">
			...
			<div class="footballgonggao" id="footballgonggao">		
				...
				<!--#include virtual="/kaijiang/shisichang.html"-->
			</div>
               ...
               <%/** <div class="footballgonggao">
				<div class="gonggao_top">预测汇总</div>
          		<div class="footballtext">
                    <ul>
                    <tangs:ryc_newslist web_id="2" categoryCn="媒体推荐" channelCn="4场进球" value="3" num="10">
					<li>${title}</li>
					</tangs:ryc_newslist>
                    </ul>
          		</div>	
		...
		<!--  ChannelBuyBanner start  -->
			<div class="ChannelBuyBanner">
				...
				<div class="ChannelBuyHandleMainTab" id="zucainavcon">
					<dl class="ChannelBuyTab">
						<dt class="light" onclick="window.location.href='/hemai/zcjinqiuhemai.html'">参与合买</dt>
			...
			<div class="ChannelBuyHandleTabContent" style="width:728px;">
				...
				<div class="BuyChoice none selected" id="zucai_area">
					<!--#include virtual="/chlw/function/zucai!getFlData?lotno=T01005"-->
				</div>
