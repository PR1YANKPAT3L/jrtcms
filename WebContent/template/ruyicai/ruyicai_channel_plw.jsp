...
<title>如意彩排列五投注、开奖公告、开奖点评、冷热号分析、奖金对照表、走势图表 </title>  
<meta http-equiv="keywords" content="排列五投注，排列五开奖公告，排列五开奖点评，排列五冷热号分析，排列五奖金对照表，排列五走势图表"/>
<meta http-equiv="description" content="如意彩排列五集投注、开奖公告、开奖点评、冷热号分析、奖金对照表、走势图表为一体是排列五一站式服务平台。"/>
...
<script type="text/javascript" src="/js/plw/plw.js"></script>
...
<div class="ChannelBuyBody">
		...
		<div class="ChannelBuyBanner">
			...
			<ol style="background:url(/images/logo_plw_d.gif) no-repeat 15px 15px;">
				<li>
					...
					<img src="/images/word_plw.gif" /><i>当前期第<strong id="qihao"></strong>期　天天开奖，固定奖金10万元！　</i><img src="../images/jrkaijiang.gif" />
				</li>	
				<li>
			...
			<div class="ChannelBuyHandleMainTab">
				<dl class="ChannelBuyTab">
					<dt class="light" onclick="window.location.href='hemai/pailie5hemai.html'">参与合买</dt>
				...
				<dd>
					<a onmouseover="PopupOn($(this));" onmouseout="PopupOff($(this));" Offset="br,0,0" BoxStyle="width:200px;line-height:20px;" Content="<tangs:ryc_newslist categoryCn="玩法简介" channelCn="排列5" value="3" web_id="%{#parameters.website_Properties_id[0]}" num="1"> <h3 style='line-height:26px;'>${title}</h3>${content}</tangs:ryc_newslist>" target="_blank" href='http://www.ruyicai.com/cms/a/bangzhuzhongxin/wanfajieshao/2012/0329/29.html?fid=36&id=29'>玩法介绍</a>
		...
		<form name="BettingForm" id="BettingForm" action="/chlw/user/bet!bettingByDipin" method="post">	
			<div class="ChannelBuyHandleTabContent">
				<div class="BuyNormalContent  none selected">	
					<jsp:include page="/function/ruyicai_plw/plw_common.jsp"/>
				</div>
				<div class="BuyUploadContent ChannelBuyUpload none">
					<jsp:include page="/function/ruyicai_plw/plw_danshiUpload.jsp"/>
				</div>
	...
	<div class="ChannelBuyInfo">
		...
		<div id="ChannelBuyBulletin">
				<%/* <script>$(function(){reHtml(45,'lotno=T01011',false,'ChannelBuyBulletin');});</script>*/ %>
				<!--#include virtual="/kaijiang/pailiewu.html"-->
		</div>
		<!--  排列5开奖公告 end  -->
		...
		<div class="ChannelBuyPannel ChannelBuyReview">
			<div class="ChannelBuyPannelHead"><h3>排列5上期开奖点评</h3></div>
			<div class="ChannelBuyPannelBody">
				<ol>
				<tangs:ryc_newslist web_id="2" categoryCn="开奖点评" channelCn="排列5" value="3" num="1">
				  <li>
					${content}
					</li>
		...
		<div class="ChannelBuyPannel ChannelBuyAnalyse">
			<div class="ChannelBuyPannelHead"><h3>排列5冷热号分析</h3></div>
			<dl class="ChannelBuyTab">
			...
			<div class="ChannelBuyPannelBody">
				...
				<tangs:ryc_newslist web_id="2" categoryCn="近30期" channelCn="排列5" value="3" num="1">
				 
					${content}
					
				</tangs:ryc_newslist>
				<tangs:ryc_newslist web_id="2" categoryCn="近50期" channelCn="排列5" value="3" num="1">
				 
					${content}
					
				
				</tangs:ryc_newslist>
				<tangs:ryc_newslist web_id="2" categoryCn="近100期" channelCn="排列5" value="3" num="1">
		...
		<div class="ChannelBuyPannel ChannelBuyCollate">
			<div class="ChannelBuyPannelHead"><h3>排列5奖金对照表</h3></div>
			<div class="ChannelBuyPannelBody">
			<tangs:ryc_newslist web_id="2" categoryCn="奖金对照表" channelCn="排列5" value="3" num="1">
		...
		<div class="ChannelBuyPannel ChannelBuyCurrent">
			<div class="ChannelBuyPannelHead"><h3>排列5图表走势</h3><a href="http://tbzs.ruyicai.com/cjwpl5/view/pl5_zst.php" title="更多"  target="_blank">更多&gt;&gt;</a></div>
			<div class="ChannelBuyPannelBody">
				<ul>
					<tangs:ryc_newslist value="3" categoryCn="频道走势图"  channelCn="排列5" web_id="%{#parameters.website_Properties_id[0]}" >
...
<!--号码蓝  提示  end-->
<script>hemaiInit();zengcaiInit();//initLotno();</script>
