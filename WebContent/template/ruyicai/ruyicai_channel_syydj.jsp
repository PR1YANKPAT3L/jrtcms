...
<script type="text/javascript" src="/js/jqueryJS/timeEnd_syydj.js"></script>
...
<script type="text/javascript" src="/js/syydj/syydj.js"></script>
...
<!--  Banner start  -->
<ol
	style="background: url(/images/logo_syydj_b.gif) no-repeat 15px 15px;">
	<li><img src="/images/word_syydj.gif" /><i>当前期第<strong
...
<dl class="ChannelBuyTab">
	...
	<dt class="light"><a
		href="/rules/user.html?key=0&view=ChildMenu2&style=menu2">我的方案</a></dt>
	<dd><a onmouseover="PopupOn($(this));"
...
<form name="BettingForm" id="BettingForm"
	action="/chlw/user/bet!bettingByGaopin" method="post">
