...
<dl class="ChannelBuyRedouble">
	...
	<dd style="width:90px;">
		<div id="zhuijia" style="display: none;">
			<input name="oneMoney" id="oneMoney" type="checkbox" value="3" onclick="setGoumaifangshi('追加');updateMultipleTotalMoney();jisuanZhuihao();"><span>追加投注</span>
		</div>
	</dd>
	...
	<dd style="width:75px; float:right;">
		...
		<img onclick="btn_ClearClick()" src="/images/qkhml.gif" />
	</dd>
</dl>
  <script>
