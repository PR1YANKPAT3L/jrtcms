...
<div class="ChannelBuyTip">玩法提示：所选号码与开奖号码按位数全部相同即中1000元。</div>
<div class="touzhuqi">
            <div class="redselect_left_3dp">
            <span class="redselect_left_zi">百　　位</span>
            <span class="redselect_left_zi1">遗　　漏</span>
            <span class="redselect_left_zi2">十　　位</span>
            <span class="redselect_left_zi1">遗　　漏</span>
            <span class="redselect_left_zi3">个　　位</span>
           	<span class="redselect_left_zi1">遗　　漏</span>
            </div>
           <div class="redselect_mid" style="width:545px;">
	 ...
	 <table class="ChannelBuyAddTable" >
		...
		<th>
			<img onclick=" btn_2_AddClickZhiF();jisuanZhuihao();" id="btn_2_Add" src="/images/addbtn.gif" />
		</th>
		<td>
			<table>
				<tr>
					...
					<td><input type="button" class="ddjxbtn" onclick='ddjx_sd_Rand($("#jixuan_Rand").val());jisuanZhuihao();'/></td>
				</tr>
			</table>
		</td>
	</tr>
