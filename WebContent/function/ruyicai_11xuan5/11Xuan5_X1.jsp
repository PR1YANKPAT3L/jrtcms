...
<div class="ChannelBuyTip">玩法提示：从11个号码中任选1个号码。所选号码与当期开奖的第一个号码相同即中奖，奖金13元。</div>
	...
	<div class="touzhuqi">
	    ...
	    <div class="AddBasketCenter">
				<div class="ChannelBuyAddButton">
					 <img src="/images/addbtn.gif" id="btn_2_Add" onclick="btn_2_AddClickX1ZhiF();jisuanZhuihao();">
				</div>
