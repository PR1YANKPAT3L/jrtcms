			...
			<div class="InsideBorder">
				<table class="PlanContent " cellpadding="0" cellspacing="0" width="100%">
					<tbody>
						...
						<tr>
							<th colspan="7" class="AscertainBuy"><a href="/rules/user.html?key=34" target="_blank">完善信息</a></th>
						</tr>
					</tbody>
				</table>
			</div>
			...
			<div class="InsideBorder">
				<table class="PlanContent" cellpadding="0" cellspacing="0" width="100%">
					<tbody>
						...
						<tr>
							<th colspan="7" class="AscertainBuy"><a href="/rules/ssq_allyears.html">进入活动专区</a></th>
						</tr>
					</tbody>
				</table>
			</div>
