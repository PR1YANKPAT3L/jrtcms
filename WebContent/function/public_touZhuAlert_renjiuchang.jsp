...
<div class="AlertWindow FootblaaPlanWindow " id="standrad_alert" style="width: 900px;">
	  ...
	  <span class="Alertclose"  onclick="loginShow('touzhuOpen1',false);" onmouseover="BtnOver($(this));" onmouseout="BtnOut($(this));" onmousedown="BtnDown($(this));" onmouseup="BtnUp($(this));">&#160;</span>
		...
		<div class="InsideBorder">
			...
			<tr id="hemai_details" class="none" >
					<td>方案详情</td>
					<th><table class="PlanContentTable" width="100%"cellspacing="0" cellpadding="0">
							<tbody>
								<tr>
					...
					<th>
						...
						<table class="PlanContentTable" cellpadding="0" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									<td>对阵</td>
									<td><span id="alert_hteam_1"></span><span>VS</span><span id="alert_vteam_1"></span></td>
									<td><span id="alert_hteam_2"></span><span>VS</span><span id="alert_vteam_2"></span></td>
									<td><span id="alert_hteam_3"></span><span>VS</span><span id="alert_vteam_3"></span></td>
									<td><span id="alert_hteam_4"></span><span>VS</span><span id="alert_vteam_4"></span></td>
									<td><span id="alert_hteam_5"></span><span>VS</span><span id="alert_vteam_5"></span></td>
									<td><span id="alert_hteam_6"></span><span>VS</span><span id="alert_vteam_6"></span></td>
									<td><span id="alert_hteam_7"></span><span>VS</span><span id="alert_vteam_7"></span></td>
									<td><span id="alert_hteam_8"></span><span>VS</span><span id="alert_vteam_8"></span></td>
									<td><span id="alert_hteam_9"></span><span>VS</span><span id="alert_vteam_9"></span></td>
									<td><span id="alert_hteam_10"></span><span>VS</span><span id="alert_vteam_10"></span></td>
									<td><span id="alert_hteam_11"></span><span>VS</span><span id="alert_vteam_11"></span></td>
									<td><span id="alert_hteam_12"></span><span>VS</span><span id="alert_vteam_12"></span></td>
									<td><span id="alert_hteam_13"></span><span>VS</span><span id="alert_vteam_13"></span></td>
									<td><span id="alert_hteam_14"></span><span>VS</span><span id="alert_vteam_14"></span></td>
									<td>&#160;</td>
									<td>&#160;</td>
								</tr>
								<tr>
									...
									<td id="alert_z13"></td>
									<td id="alert_z14"></td>
									<td id="beishu" rowspan="2"></td>
									<td rowspan="2"><b id="zongJine"></b></td>
								</tr>
								<tr>
										<td height="28" class="zucaiwin_tr2">设胆</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_1"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_2"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_3"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_4"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_5"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_6"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_7"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_8"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_9"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_10"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_11"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_12"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_13"></font>
										</td>
										<td class="zucaiwin_tr2"><font class="red1" id="selected_14"></font>
										</td>
									</tr>
							</tfoot>
						</table>
...
<div class="AlertWindow PlanBuyWindow WindowDrag"  id="danshi_alert" style="display: none;">
	<div class="WindowTittle">
...
<script>
	...
	function htmlMsg() {
		...
		if(erjiwanfa==decodeURI(EncodeUtf8("普通投注"))) {
			...
			var xx=$("#zucai_tishi").html();
			var one;
			if(xx!=""){
				var zong = xx.substring(0,2);
				one=Number(zong)-two-all;
			}else{
				one=9-two-all;
			}
			$("#alert_one").text(one);
			...
			var length_zhuma = alert_zhuma.split("$").length;
			...
			if(length_zhuma==2) {
				...
				var danmaArray = new Array();
				var tuomaArray = new Array();
				zhumaArray = alert_zhuma.split("$");
				danmaArray = zhumaArray[0].split(",");
				tuomaArray = zhumaArray[1].split(",");
				for(var i = 0;i < danmaArray.length;i++) {
					$("#alert_z"+(i+1)).text(danmaArray[i]);
					if(!(danmaArray[i]=="#")) {
						$("#selected_"+(i+1)).html("&radic;");
					}
				}
				for(var i = 0;i < tuomaArray.length;i++) {
					if(!(tuomaArray[i]=="#")) {
						$("#alert_z"+(i+1)).text(tuomaArray[i]);
					}
				}
			}else {
				var zhumaArray = new Array();
