<%@ page contentType="text/html; charset=utf-8" pageEncoding="utf-8"%>
 ...
 <div class="touzhuqi">
            <div class="redselect_left" style="padding-left:110px;"><span class="redselect_left_zi1">选择号码</span><span class="redselect_left_zi1">本期遗漏</span></div>
            ...
            <div class="ChannelBuyAddBasket">
				<div class="AddBasketCenter">
					<div class="ChannelBuyAddButton">
						<img onclick="btn_2_AddClickZu3F();jisuanZhuihao();" id="btn_Zu3F_Add"  src="/images/addbtn.gif" />
					</div>
