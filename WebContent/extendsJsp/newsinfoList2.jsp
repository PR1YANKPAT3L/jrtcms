...
//当前的分类id
Long categoryId =Long.valueOf(request.getParameter("categoryID")==null?"0":request.getParameter("categoryID"));
//当前的频道id
Long channelId =Long.valueOf(request.getParameter("channelID")==null?"0":request.getParameter("channelID"));

//获取新闻列表
List<News> newsInfoList2 = newservice.queryNewsInIdForList(channelId, categoryId,
		null,12,websiteId);
...
//保存到requset
request.setAttribute("newsInfoList2",newsInfoList2);
