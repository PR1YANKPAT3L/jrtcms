...
<div class="AlertWindow FootblaaPlanWindow" id="standrad_alert" >
	...
	<div class="InsideBorder">
		<table class="PlanCon" cellpadding="0" cellspacing="0" width="100%">
			...
			<tfoot>
			<tr>
				<th colspan="2" class="AscertainBuy"><input class="BtnDisable" type="button" id="norepeat" onclick="norepeat(this);touzhu();" onmouseover="BtnOver($(this));" onmouseout="BtnOut($(this));" onmousedown="BtnDown($(this));" onmouseup="BtnUp($(this));"><span><a onclick="loginShow('touzhuOpen1', false);" title="返回修改">返回修改</a></span></th>
			</tr>
			</tfoot>
		</table>
	</div>
