...
<!-- 弹出框 开始 -->
<div style="display: none;" id="touzhuOpenShouye" class="WindowCenter">
<div class="AlertWindow FootblaaPlanWindow" id="standrad_alert" >
	...
	<div class="InsideBorder">
		<table class="PlanCon" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				<td>认购信息</td><th align="left">您本次购买需消费<b><span id="xiaofei"></span></b>元，购买后您的账户余额为<b><span id="zhanghujine"></span></b>元</th>
			</tr>
			</tbody>
			<tfoot>
			<tr>
				<th colspan="2" class="AscertainBuy"><input class="BtnDisable" type="button" id="norepeat" onclick="norepeat(this);touzhu();" onmouseover="BtnOver($(this));" onmouseout="BtnOut($(this));" onmousedown="BtnDown($(this));" onmouseup="BtnUp($(this));"><span><a onclick="loginShow('touzhuOpenShouye', false);" title="返回修改">返回修改</a></span></th>
			</tr>
			</tfoot>
		</table>
	</div>
			...
			<div class="InsideBorder">
				<table class="PlanCon" cellpadding="0" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							<th colspan="5" class="AscertainBuy"><input class="BaseBtn" type="button" id="norepeat" onclick="norepeat(this);touzhu();" value="确认购买" onmouseover="BtnOver($(this));" onmouseout="BtnOut($(this));" onmousedown="BtnDown($(this));" onmouseup="BtnUp($(this));"><span class="light" onclick="loginShow('touzhuOpenShouye', false);">返回修改</span></th>
						</tr>
					</tbody>
				</table>
			</div>
