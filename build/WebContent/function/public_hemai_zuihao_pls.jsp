              ...
              <div class="buy_content1">
				...
				<div class="buy_cont">
				  ...
				  <div id="loginStaticInMoney" class="buy_con_list">
					...
					<div class="buy_con_list" style="margin:0px 0px 0px 10px; line-height:22px;"><input name="xieyi" id="fengxiang" type="checkbox" value="" checked="checked">彩票发行中心对排列三进行<span class="buy_blue"><a href="/rules/pls_RiskFile.html"  title="限号管理" target="_blank">限号管理</a></span>，我已阅读并同意网站<br />
					<span class="buy_blue"><a href="/rules/pls_RiskFile.html" title="投注风险须知议" target="_blank">《排列三投注风险须知》</a></span></div>
				</div>
