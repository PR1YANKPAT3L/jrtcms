...
<div class="buy_title">
		...
		<div class="buy_fl">
			<ul>
				...
				<li><input name="daiGou" type="radio" value=""  id="zuiHao" onclick="daiGou_heMai(),getBalance()"/>追号</li>
			</ul>
		</div>
...
<!-- 代购 -->
	<div class="buy_content1" id="daiGouDIV">
		...
		<div class="buy_tzh"><img src="/images/buy_btn.gif" alt="立即投注" title="立即投注" width="123" height="37"   onclick="touzhu()"/></div>
	</div>
...
<!-- 
	...
	<div class="sub_content">
		...
		<div class="sub_con">
			<div class="sub_con_list"><span class="buy_blue"><s:property value="#session.users.userName"/></span>，您的账户余额为<span class="buy_red" id="touzhu_money"></span>元【<img src="/images/zhanghuchongzhi.gif" height="8"/>
