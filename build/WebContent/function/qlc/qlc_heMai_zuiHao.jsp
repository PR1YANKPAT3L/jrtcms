...
<!-- 代购 -->
	<div class="buy_content1" id="daiGouDIV">
		...
		<div class="buy_tzh">
			<img src="/images/buy_btn.gif" width="123" height="37" alt="立即投注" title="立即投注" onclick="touzhu()"/>
		</div>
	</div>
...
<!-- 
	...
	<div class="sub_content">
		...
		<div class="sub_con">
			<div class="sub_con_list"><span class="buy_blue"><s:property value="#session.users.userName"/></span>，您的账户余额为<span class="buy_red" id="deposit_amount"></span>元【<img src="/images/zhanghuchongzhi.gif" height="8"/>
