					...
					<th>
						<table class="PlanContentTable" cellpadding="0" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									<td width="50">对阵</td>
									<td width="22"><span id="alert_hteam_1_b"></span><span>VS</span><span id="alert_vteam_1_b"></span><font class="red1">半</font></td>                                 
									<td width="22"><span id="alert_hteam_1_q"></span><span>VS</span><span id="alert_vteam_1_q"></span><font class="red1">全</font></td>                                 
									<td width="22"><span id="alert_hteam_2_b"></span><span>VS</span><span id="alert_vteam_2_b"></span><font class="red1">半</font></td>                                 
									<td width="22"><span id="alert_hteam_2_q"></span><span>VS</span><span id="alert_vteam_2_q"></span><font class="red1">全</font></td>                                
									<td width="22"><span id="alert_hteam_3_b"></span><span>VS</span><span id="alert_vteam_3_b"></span><font class="red1">半</font></td> 
									<td width="22"><span id="alert_hteam_3_q"></span><span>VS</span><span id="alert_vteam_3_q"></span><font class="red1">全</font></td>
									<td width="22"><span id="alert_hteam_4_b"></span><span>VS</span><span id="alert_vteam_4_b"></span><font class="red1">半</font></td>
									<td width="22"><span id="alert_hteam_4_q"></span><span>VS</span><span id="alert_vteam_4_q"></span><font class="red1">全</font></td>
									<td width="22"><span id="alert_hteam_5_b"></span><span>VS</span><span id="alert_vteam_5_b"></span><font class="red1">半</font></td>
									<td width="22"><span id="alert_hteam_5_q"></span><span>VS</span><span id="alert_vteam_5_q"></span><font class="red1">全</font></td>
									<td width="22"><span id="alert_hteam_6_b"></span><span>VS</span><span id="alert_vteam_6_b"></span><font class="red1">半</font></td>
									<td width="22"><span id="alert_hteam_6_q"></span><span>VS</span><span id="alert_vteam_6_q"></span><font class="red1">全</font></td>
									<td width="50">&#160;</td>
									<td>&#160;</td>
								</tr>
								<tr>
									<td>选号</td>
									<td id="alert_zhuma_1"></td>
									<td id="alert_zhuma_2"></td>
									<td id="alert_zhuma_3"></td>
									<td id="alert_zhuma_4"></td>
									<td id="alert_zhuma_5"></td>
									<td id="alert_zhuma_6"></td>
									<td id="alert_zhuma_7"></td>
									<td id="alert_zhuma_8"></td>
									<td id="alert_zhuma_9"></td>
									<td id="alert_zhuma_10"></td>
									<td id="alert_zhuma_11"></td>
									<td id="alert_zhuma_12"></td>
									<td id="beishu"></td>
...
<script>
	...
	function htmlMsg(){
		...
		if(erjiwanfa==decodeURI(EncodeUtf8("普通投注"))) {
			...
			for (var i = 1; i <= 6; i++) {
				$("#alert_hteam_" + i + "_b").text($("#hteam_" + i).text());
				$("#alert_hteam_" + i + "_q").text($("#hteam_" + i).text());

				$("#alert_vteam_" + i + "_b").text($("#vteam_" + i).text());
				$("#alert_vteam_" + i + "_q").text($("#vteam_" + i).text());
			}
			...
			for(var i = 0;i < zhumaArray.length;i++) {
				$("#alert_zhuma_"+(i+1)).text(zhumaArray[i]);
			}
