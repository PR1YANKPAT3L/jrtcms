...
<script type="text/javascript">
	function ajaxFileUploadzx()
    {
        ...
        (
          {
               url:'/chlw/function/upload!doUploadFile?type='+$("#type_zx").val(), //你处理上传文件的服务端
               secureuri:false,
	...
	<li>
		<div class="upload_text" onmouseover="showzxDiv()" onmouseout="closezxDiv()">
			...
			<div class="yangben_content" id="ybzx" style="display: none; width:160px;">
				...
				<div class="yangben" >
				<table>
				<tr><td>标准样式一：</td><td>564</td></tr>
				<tr><td>&nbsp;</td><td>809</td></tr>
				<tr><td>标准样式二：</td><td>5,6,4</td></tr>
...
<dl>
	...
	<dd>2、 请严格参照<font class="upload_blue"><a target="_blank" href='<tangs:ryc_newslist value="3" categoryCn="普通单式上传标准" channelCn="福彩3D" web_id="%{#parameters.website_Properties_id[0]}" num="1">${url }</tangs:ryc_newslist>' title="标准格式样本">“标准格式样本”</a></font>格式上传方案，否则不能完成投注。</dd>
	<dd>3、 文件格式必须是文本文件。</dd>
	<dd>4、 由于上传的文件较大，会导致上传时间及在本页停留时间较长，请耐心等待。</dd>
</dl></div>
            <div class="add_basket1"><span class="add_btton1"><img onclick="return ajaxFileUploadzx();" id="btn_2_Add" src="../images/addbtn.gif" /></span></div>
