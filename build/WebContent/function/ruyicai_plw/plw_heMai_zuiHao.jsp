...
<div class="buy_title">
		...
		<div class="buy_fl">
			<ul>
				...
				<li><input name="daiGou" type="radio" value=""  id="zuiHao" onclick="daiGou_heMai(),loadSelect()"/>追号</li>
			</ul>
		</div>
	...
	<div class="buy_content1" id="daiGouDIV">
		...
		<div class="buy_con">		
			...
			<div class="buy_con_list">
				...
				我已阅读并同意《<a href="/rules/betProtocol.html" title="用户代购协议" target="_bank"><span class="buy_blue">用户代购协议</span></a>》
			</div>
		</div>
		<div class="buy_tzh">
