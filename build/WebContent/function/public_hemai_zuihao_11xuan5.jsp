...
<%@taglib prefix="tangs" uri="/WEB-INF/tangs.tld" %>
		...
		<div class="FollowNub"><!-- 追号 start -->
			...
			<dl class="ChannelBuyTab FollowNubTab">
				<dd>购买方式</dd>
				<dt class="light selected"  ControlTarget="FollowNubTab1" id="daiGou" onclick="setGoumaifangshi('代购');setdaigouOrzhuihao('daigou');"><span>&nbsp;</span>代购</dt>
				<dt class="light" ControlTarget="FollowNubTab3" id="zuiHao" onclick="setGoumaifangshi('追号');setdaigouOrzhuihaoByGaopin('zhuihao');" ><span>&nbsp;</span>收益率追号</dt>
				...
				<dd class="TabEm" id="ZhuiHao" style="display: none"><a  target="_blank" href='<tangs:ryc_newslist categoryCn="收益率追号功能说明" channelCn="江西11选5" value="3" web_id="%{#parameters.website_Properties_id[0]}" num="1">${url }?id=${id }&code1=${categoryCode}&code=${pcode}</tangs:ryc_newslist>'>什么叫收益率追号？</a></dd>
				<dd class="TabEm" id="ZYZH" style="display: none"><a  target="_blank" href="/bangzhuzhongxin/goucaibangzhu/zhuihao/20110905105245_2700.html?id=2700&code1=202&code=126">连续多期购买同一个（组）号码</a></dd>
			</dl>
									...
									<tr>
										<th>&#160;</th>
											<td>
												...
												前<input type="text" class="text" value="5" id="qianqi_count" onkeyup="value=value.replace('０','0').replace('１','1').replace('２','2').replace('３', '3').replace('４','4').replace('５','5').replace('６','6').replace('７', '7').replace('８','8').replace('９','9');checkBeishu('qianqi_count',99);calculate();" disabled="disabled"/>
					...
					<tr>
						...
						<td style="padding-right:0px;">
							<ul>
								...
								<li><input type="checkbox" checked="checked" id="xieyi"/>我已阅读并同意<a class="light" href="/rules/betProtocol.html" target="_blank">《用户代购协议》</a>。</li>
								<li><input type="checkbox" checked="checked" id="fengxiang"/>我已阅读并同意<span class="buy_blue"><a href="/rules/11xuan5Risk.html" title="限号管理" target="_blank">限号管理</a></span>和<a class="light" href="/rules/11xuan5Risk.html" target="_blank">《江西11选5投注风险须知》</a>。</li>
							</ul>
						</td>
...
<script>$(function() {get100QiHao(55,'lotno=T01010&num=100',false,'kaishiqihao');});</script>		
