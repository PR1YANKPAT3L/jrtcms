...
<script type="text/javascript">
	function ajaxFileUploadzs()
    {
        ...
        (
          {
               url:'/chlw/function/upload!doUploadFile?type='+$("#type_zs").val(), //你处理上传文件的服务端
               secureuri:false,
               ...
               success: function (data)
               {
            		if(data.bool){
            					...
            					$("#list_LotteryNumber").append("<option id='单式上传' value='' wangfang='dssc_zs'>单式上传</option>");
...
<ul>
	...
	<li style="position:relative;">
		<div class="InputFile">
			 <input type="hidden" value="plszs" id="type_zs"/>
	...
	<li>
		<div class="upload_text" onmouseover="showzsDiv()" onmouseout="closezsDiv()">
			...
			<div class="yangben_content" id="ybzs" style="display: none; width:160px;">
				<div class="sanjiao">
					<img class="smalljt1" src="../images/xsjicon1.gif"/>
				</div>
				<div class="yangben" >
				<table>
				<tr><td>标准样式一：</td><td>188</td></tr>
				<tr><td>&nbsp;</td><td>255</td></tr>
				<tr><td>标准样式二：</td><td>1,8,8</td></tr>
				<tr><td>&nbsp;</td><td>2,5,5</td></tr>
				</table>
				</div>
			</div>
		</div>
...
<dl>
	...
	<dd>2、 请严格参照<font class="upload_blue"><a target="_blank" href='<tangs:ryc_newslist value="3" categoryCn="组三单式上传标准" channelCn="排列3" web_id="%{#parameters.website_Properties_id[0]}" num="1">${url }</tangs:ryc_newslist>' title="标准格式样本">“标准格式样本”</a></font>格式上传方案，否则不能完成投注。</dd>
	<dd>3、 文件格式必须是文本文件。</dd>
	<dd>4、 由于上传的文件较大，会导致上传时间及在本页停留时间较长，请耐心等待。</dd>
</dl></div>
            <div class="add_basket1"><span class="add_btton1"><img onclick="return ajaxFileUploadzs();" id="btn_2_Add" src="../images/addbtn.gif" /></span></div>
