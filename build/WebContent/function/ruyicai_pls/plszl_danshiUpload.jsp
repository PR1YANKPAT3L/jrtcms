...
<dl>
	...
	<dd>2、 请严格参照<font class="upload_blue"><a target="_blank" href='<tangs:ryc_newslist value="3" categoryCn="组六单式上传标准" channelCn="排列3" web_id="%{#parameters.website_Properties_id[0]}" num="1">${url }</tangs:ryc_newslist>' title="标准格式样本">“标准格式样本”</a></font>格式上传方案，否则不能完成投注。</dd>
	<dd>3、 文件格式必须是文本文件。</dd>
