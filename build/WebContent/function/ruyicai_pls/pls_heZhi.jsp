...
<div class="ChannelBuyTip">玩法提示：所选的和值与开奖号码和值相同即中1,000元。</div>
<div class="touzhuqi">
            <div class="redselect_left" style="padding-left:45px;"><span class="redselect_left_zi">选择和值</span>
            <span class="redselect_left_zi1">本期遗漏</span><!-- <span class="redselect_left_zi1">理论遗漏</span> --><span class="redselect_left_zi1">选择和值</span><span class="redselect_left_zi1">本期遗漏</span><!-- <span class="redselect_left_zi1">理论遗漏</span> --></div>
            ...
            <div class="ChannelBuyAddBasket">
				<div class="AddBasketCenter" style="width:130px;">
					<div class="ChannelBuyAddButton">
						<img onclick="plsZhiHe_AddClick();jisuanZhuihao();" id="btn_addEvent"  src="/images/addbtn.gif" />
					</div>
				</div>
		 </div>
 </div>       