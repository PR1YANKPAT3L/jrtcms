...
<%@taglib prefix="tangs" uri="/WEB-INF/tangs.tld" %>
		...
		<div class="FollowNub"><!-- 追号 start -->
			...
			<dl class="ChannelBuyTab FollowNubTab">
				...
				<dd class="TabEm" id="ZhuiHao" style="display: none"><a target="_blank" href='<tangs:ryc_newslist categoryCn="收益率追号功能说明" channelCn="时时彩" value="3" web_id="%{#parameters.website_Properties_id[0]}" num="1">${url }?id=${id }&code1=${categoryCode}&code=${pcode}</tangs:ryc_newslist>'>什么叫收益率追号？</a></dd>
					...
					<tr>
						...
						<td style="padding-right:0px;">
							<ul>
								...
								<li><input type="checkbox" checked="checked" id="fengxiang" />我已阅读并同意<span class="buy_blue"><a href="/rules/sscRisk.html" title="限号管理" target="_blank">限号管理</a></span>和<a class="light" href="/rules/sscRisk.html" target="_blank" >《时时彩投注风险须知》</a>。</li>
							</ul>
						</td>
