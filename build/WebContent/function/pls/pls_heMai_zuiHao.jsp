...
<div class="buy_title">
		...
		<div class="buy_fl">
			<ul>
			  	<li><input name="daiGou" type="radio" value="" checked="checked"  id="daiGou" onclick="daiGou_heMai()"/>代购</li>
				<!--<li><input name="daiGou" type="radio" value=""  id="heMai" onclick="daiGou_heMai()"/>合买</li>-->
				<li><input name="daiGou" type="radio" value=""  id="zuiHao" onclick="daiGou_heMai()"/>追号</li>
			</ul>
		</div>
		<div class="buy_self"><span id="gmzh_text">由购买人自行全额购买彩票</span><span><img src="/images/buy_wen.gif"/></span></div>
</div>
...
<!-- 代购 -->
	<div class="buy_content1" id="daiGouDIV">
		...
		<div class="buy_con">
			...
			<div class="buy_con_list">
				...
				我已阅读并同意<a href="/rules/betProtocol.html" title="用户代购协议" target="_blank"><span class="buy_blue">《用户代购协议》</span></a>
			</div>
				<div class="buy_con_list">
				<input name="fengxiang" id="fengxiang" type="checkbox" value="" checked="checked"/>
				彩票发行中心对排列三进行限号管理
				，我已阅读并同意网站<a href="/rules/pls_RiskFile.html">《<span class="buy_blue">排列三投注风险须知</span>》</a>
				</div>
		</div>
		<div class="buy_tzh">
			<img src="/images/buy_btn.gif" alt="立即投注" title="立即投注" width="123" height="37"  onclick="touzhu()"/>
		</div>
	</div>
	...
	<div class="sub_content">
		...
		<div class="sub_con">
			<div class="sub_con_list"><span class="buy_blue">“g11105”</span>，您的账户余额为<span class="buy_red">¥46.00</span>元【<img src="/images/zhanghuchongzhi.gif" height="8"/>
