...
<%@taglib prefix="s" uri="/struts-tags"%>
		<div class="FollowNub"><!-- 追号 start -->
			<dl class="ChannelBuyTab FollowNubTab">
				...
				<dd class="TabEm" id="HeMaiTiShi" style="display: none"><a  target="_blank" href='/bangzhuzhongxin/wanfajieshao/guanfangwanfajieshao/20111021135742_3737.html?id=3737&code1=135&code=129'>由多人共同出资购买彩票</a></dd>
				<dd class="TabEm" id="ZengSong" style="display: none"><a  target="_blank" href='/bangzhuzhongxin/goucaibangzhu/zengcaishuoming/20111229170802_5370.html?id=5370&code1=207&code=126'>由购买人赠送好友彩票</a></dd>
			</dl>
					...
					<table class="ChannelBuyTable">
						<tr>
							...
							<td class="GiftContent">								
								<ul>
								<li><input id="ownCheck" name="ownCheck" type="checkbox" checked="checked" value="1" onclick="ownMessage();" />自购<input class="TextInputMini" type="text"  value="1"  id="ownMultiple" onkeyup="multipleValidateZengCai('ownMultiple');changeSingleMultiple('ownMultiple','ownMoney','own');" />倍，金额<i id="ownMoney1">0</i>元</li>
