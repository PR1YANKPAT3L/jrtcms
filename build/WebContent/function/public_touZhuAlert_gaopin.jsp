			...
			<div class="InsideBorder">
				<table class="PlanContent" cellpadding="0" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							<th colspan="5" class="AscertainBuy"><input class="BtnDisable" type="button" id="norepeat" onclick="norepeat(this);touzhu();"  onmouseover="BtnOver($(this));" onmouseout="BtnOut($(this));" onmousedown="BtnDown($(this));" onmouseup="BtnUp($(this));"><span class="light" onclick="clearForm();loginShow('touzhuOpen1', false);">返回修改</span></th>
						</tr>
					</tbody>
				</table>
			</div>
				...
				<table class="PlanContent" cellpadding="0" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<input class="BtnDisable" type="button" onclick="norepeat(this);touzhu();" ><span><a href="javaScript:clearForm();closeAjaxLogin('openTouzhu3');" title="返回修改"><span class="light">返回修改</span></a></span></th>
						</tr>
					</tbody>
				</table>
			</div>
	    	   ...
	    	   $("#qihaofanan2").html(lotno+" 第"+qihao+"期 "+dangqianwanfa+erjiwanfa+" "+goumaifangshi+"方案"); //彩种 期号 投注方式 方案 
		        ...
		        if($("#fenqikoukuan").hasClass("selected")){
		    		...
		    		if($("#zhongType1")!=null||$("#zhongType1")!=undefined){
		    			if($("#zhongType1").attr('checked')==true){
		    				$("#payStop").val("1");
		    			}else{
		    				$("#payStop").val("0");
		    			}
		    		...
		    		if($("#zhongType2")!=null||$("#zhongType2")!=undefined){
		    			if($("#zhongType2").attr('checked')==true){
		    				$("#payStop").val("1");
		    			}else{
		    				$("#payStop").val("0");
		    			}
		        ...
		        if($("#fenqikoukuan1").hasClass("selected")){
		    		...
		    		if($("#zhuihaoSms1")!=null||$("#zhuihaoSms1")!=undefined){
		    			if($("#zhuihaoSms1").attr('checked')==true){
		    				$("#smsType").val("1");
		    			}else{
		    				$("#smsType").val("0");
		    			}
