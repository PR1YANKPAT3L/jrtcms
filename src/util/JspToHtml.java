...
public class JspToHtml {
	...
	/**
	 * 
	 * @param vmSourcePath 模板文件的路径
	 * @param htmlSourcePath 生成html文件的路径
	 * @param htmlSourceFileName 生成html的文件名称
	 * @throws Exception 当读取文件路径错误、数据流读写异常时向外抛出异常
	 */
	public static void jspToHtml(String vmSourcePath, 
			String htmlSourcePath,String htmlSourceFileName)throws Exception{
